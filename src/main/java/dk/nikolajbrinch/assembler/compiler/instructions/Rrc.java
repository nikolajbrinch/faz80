...
public class Rrc implements InstructionGenerator {
  ...
  public ByteSource generateIndexed(NumberValue currentAddress, Operand targetIndex) {
    ...
    if (targetRegister == Register.IX) {
      return ByteSource.of(0xDD, 0xCB, targetIndex.displacementD(), 0x0E);
    } else if (targetRegister == Register.IY) {
      return ByteSource.of(0xFD, 0xCB, targetIndex.displacementD(), 0x0E);
    }
  ...
  public ByteSource generateRegisterToIndexed(
    ...
    if (targetRegister == Register.IX) {
      return ByteSource.of(
          ...
          InstructionGenerator.implied1(0b00001000, Registers.r, register));
    } else if (targetRegister == Register.IY) {
      return ByteSource.of(
          0xFD,
          0xCB,
